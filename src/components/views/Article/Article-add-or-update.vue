...
export default {
  ...
  data () {
    return {
      ...
      coverTypeList: [{"id":7,"parKey":0,"parValue":"小图片","menuUrl":"/article-addOrUpdate","type":"ARTICLE_COVER_TYPE"},{"id":8,"parKey":1,"parValue":"大图片","menuUrl":"/article-addOrUpdate","type":"ARTICLE_COVER_TYPE"},{"id":9,"parKey":2,"parValue":"无图片","menuUrl":"/article-addOrUpdate","type":"ARTICLE_COVER_TYPE"}],//this.getSysParamArr('ARTICLE_COVER_TYPE'),
      url: '',
      file: [],
      rules: {
